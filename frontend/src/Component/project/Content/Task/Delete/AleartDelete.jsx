...
import { deleteTask } from "../../../../../Redux/APIRequest/apiTaskRequest";
import { createAxios } from "../../../../../createInstance";
import { useDispatch, useSelector } from "react-redux";
import { useNavigate } from "react-router-dom";
function AleartDelete({ idTask, handleClick }) {
    ...
    function handleDelete() {
        handleClick();
        deleteTask(dispatch, navigate, accessToken, axiosJWT, idTask)
    }
    return (
        <>
